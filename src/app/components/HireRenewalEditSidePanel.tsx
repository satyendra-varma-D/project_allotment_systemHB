...
import { X, Calendar, FileText, DollarSign, CheckCircle2, AlertCircle, Users } from 'lucide-react';
import { ResourceEngagementData } from '../types/ResourceEngagement';

interface HireRenewalEditSidePanelProps {
  isOpen: boolean;
  onClose: () => void;
  engagement?: ResourceEngagementData | null;
  onSave: (data: ResourceEngagementData) => void;
}

const initialEngagementData: ResourceEngagementData = {
  projectCode: '',
  projectName: '',
  clientName: '',
  crt: '',
...
export function HireRenewalEditSidePanel({
  isOpen,
  onClose,
  engagement,
  onSave,
}: HireRenewalEditSidePanelProps) {
  const [formData, setFormData] = useState<ResourceEngagementData>(initialEngagementData);
  ...
  useEffect(() => {
    if (isOpen) {
      if (engagement) {
        ...
        setFormData(initialEngagementData);
      }
    }
  }, [isOpen, engagement]);
    ...
    <>
      ...
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-2xl bg-white dark:bg-neutral-900 shadow-2xl z-50 flex flex-col animate-in slide-in-from-right duration-300">
        ...
        <div className="px-6 py-4 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-neutral-900 dark:text-white">
              {engagement ? 'Edit Resource' : 'Add New Resource'}
            </h2>
            <p className="text-neutral-500 mt-1 uppercase tracking-wider font-medium text-[11px]">
              Manage resource engagement and directory details
            </p>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 scrollbar-hide">
          <form id="engagement-form" onSubmit={handleSubmit} className="space-y-8 pb-10">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
                    Resource Name (CRT) <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    name="crt"
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
                    Resource Type (Designation / Seniority) <span className="text-red-500">*</span>
                  </label>
                  <select
                    name="resourceType"
        ...
        <div className="px-6 py-4 border-t border-neutral-200 dark:border-neutral-800 flex items-center justify-end gap-3 bg-neutral-50 dark:bg-neutral-900/50">
          ...
          >
            {engagement ? 'Update Resource' : 'Create Resource'}
          </button>
        </div>
      </div>
    </>
