...
interface ResourceRenewalsEditSidePanelProps {
  isOpen: boolean;
  onClose: () => void;
  renewal?: any; // Pass renewal data for editing
  onSave?: (data: any) => void;
}

export function ResourceRenewalsEditSidePanel({ isOpen, onClose, renewal, onSave }: ResourceRenewalsEditSidePanelProps) {
        ...
        <div className="px-6 py-4 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
              {renewal ? 'Update renewal details' : 'Create a new renewal'}
            </p>
          </div>
          <button
            onClick={onClose}
